...
FEATURE_COLS = [
    ...
    # Pre-computed score components (now includes alumni_score)
    'mentorship_score', 'network_score', 'skill_learning_score',
    'role_synergy_score', 'alumni_score', 'career_score', 'industry_score'
]
...
# Save model
model_path = f"data/models/compatibility_model_v2.joblib"
...
with open("data/models/feature_columns_v2.txt", 'w') as f:
    f.write('\n'.join(FEATURE_COLS))
...
with open("data/models/model_metadata_v2.json", 'w') as f:
